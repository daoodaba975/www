      ...
      <div class="projects container-inner mx-auto text-xl py-16 mb-16 relative">
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          ...
          <li class="github">
            ...
            <a href="https://github.com/DevOlutionLab/xex-corona-app" target="_blank">Learn more</a> </div>
          </li>
          <li class="github">
            <div>💡 Djolof Tech Food</div>
            <div class="text-lg text-gray-600">Guide to Djolof Tech which is consumed the most on the internet (Food) and which has a strong export potential.<br>
            <a href="https://github.com/Code-for-Senegal/Djolof-Tech-Food" target="_blank">Learn more</a> </div>
          </li>
        </ul>
