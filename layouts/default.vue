  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/"><img src="~/assets/img/logo.svg" alt="logo" class="w-32" /></nuxt-link>
          <nuxt-link v-else to="/"><img src="~/assets/img/logo-white.svg" alt="logo" class="w-32" /></nuxt-link>
        </div>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://twitter.com/daoodaba975" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://facebook.com/daoodaba975/" target="_blank" class="text-white hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
            </a>
          </li>
          <li>
            <a href="https://github.com/daoodaba975" target="_blank" class="text-white hover:text-gray-400">
