  ...
  <div>
    ...
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        ...
        <div class="text-green-700 leading-tight">Full-Stack Software Engineer 👨🏽‍💻</div>
      </div>
    ...
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl">
        I am a Full-Stack Software Engineer based in Guédiawaye (Dakar, SENEGAL) working in the field of web and mobile development. <br> I am currently working in Remote. <br>
