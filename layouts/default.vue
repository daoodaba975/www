    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:daoodaba975@gmail.com" aria-label="Mail" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/daoodaba975" aria-label="Twitter" target="_blank" rel="noopener" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/daoodaba975" aria-label="GitHub" target="_blank" rel="noopener" class="text-white hover:text-gray-400">
