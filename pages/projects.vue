      ...
      <div class="projects container-inner mx-auto text-xl border-t border-gray-500 border-b py-16 mb-16 relative">
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          ...
          <li class="checkmark">
            ...
            <a href="https://github.com/daoodaba975/bilan" target="_blank">Visit website</a> </div>
          </li>
          <li class="checkmark">
            ...
            <a href="https://github.com/daoodaba975/basics-frontend-components-collections" target="_blank">Visit website</a> </div>
          </li>
          <li class="checkmark">
            ...
            <a href="https://github.com/daoodaba975/WEB-project-generator-with-GO" target="_blank">Visit website</a> </div>
          </li>
        </ul>
