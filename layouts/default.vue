<template>
  ...
  >
    <header
      class="border-t-8 bg-background-primary border-green-700 mt-0 fixed w-full z-10 pin-t mask-custom"
    >
      <nav
        class="container mx-auto flex flex-wrap justify-between items-center py-3"
      >
        <div>
          <nuxt-link v-if="theme === 'theme-light'" :to="localePath('/')"
            ><h1 class="wave">DEV</h1></nuxt-link
          >
